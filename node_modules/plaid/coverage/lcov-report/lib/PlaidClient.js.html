...
&nbsp;
    var context = R.merge({env: this.env}, withPublicKey ? <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
<span class="fstat-no" title="function not covered" >  function(access_token, mfa_type, responses, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
      path: '/item/mfa',
      body: {
        access_token: access_token,
...
<span class="fstat-no" title="function not covered" > function(access_token, credentials, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<span class="fstat-no" title="function not covered" >  function(count, offset, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Aug 10 2017 18:02:38 GMT-0700 (PDT)
</div>
</div>
