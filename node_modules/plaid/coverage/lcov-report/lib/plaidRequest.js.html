...
<span class="cstat-no" title="statement not covered" >      if (R.isArrayLike(args)) {</span>
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (isMfa &amp;&amp; res.statusCode === 200) {
<span class="cstat-no" title="statement not covered" >    return resolve([null, $body]);</span>
&nbsp;
  // mfa response (MFA)
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (isMfa &amp;&amp; res.statusCode === 210) {
